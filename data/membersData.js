const membersData = [
    {
        ...
        picture: "noriePic",
        description: "I apply of what I've learned about UI/UX design principles, such as element spacing, typography, and content block usage, I use Figma to create a design for our system. After designing, I used React Native to build a working mobile application, applying the basic concepts of the framework. I implemented navigation for accessing different pages, styled the application, and created various interactive pages. I also practiced version control by uploading the project to GitHub and followed best practices for file organization, ensuring the code is easy for others to understand."
    },
    {
        id: 2,
        name: "Brando Baja",
        assign: "User Persona, Styling",
        picture: "brandoPic",
    ...
    },
    {
        ...
        assign: "UI/UX Designer, Color Styling, User Persona, UI/UX Designer, Color Styling, User Persona, UI/UX Designer, Color Styling, User Persona",
        picture: "harlenPic",
        description: "Aye"
    },
    {
